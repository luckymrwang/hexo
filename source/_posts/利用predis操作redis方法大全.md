title: 利用predis操作redis方法大全
date: 2016-05-01 11:36:34
tags: [Redis]
---

[predis](https://github.com/nrk/predis)是php连接redis的操作库，由于它完全使用php编写，大量使用命名空间以及闭包等功能，只支持php5.3以上版本，故实测性能一般，每秒25000次读写，相信改换c语言编写的php扩展后性能会大幅提升(比如使用C扩展[phpredis](https://github.com/owlient/phpredis))。
